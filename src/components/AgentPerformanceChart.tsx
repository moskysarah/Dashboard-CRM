...
import { getMyAgentsPerformance } from '../api/myAgents';
  ...
  useEffect(() => {
    const fetchPerformanceData = async () => {
      try {
        ...
        setPerformanceData([
          { agent: 'Agent A', transactions: 150, revenue: 2500, successRate: 85, commissions: 125 },
          { agent: 'Agent B', transactions: 120, revenue: 1800, successRate: 78, commissions: 90 },
          { agent: 'Agent C', transactions: 200, revenue: 3200, successRate: 92, commissions: 160 },
        ]);
      } finally {
        setLoading(false);
      }
    ...
    <div className="bg-white rounded-xl shadow-lg p-6 w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-lg">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-sm text-blue-600 font-medium">Taux de Réussite Moyen</p>
        ...
        <div className="bg-gradient-to-r from-purple-50 to-purple-100 p-4 rounded-lg">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-sm text-purple-600 font-medium">Commissions Totales</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          <h4 className="text-lg font-semibold mb-4 text-gray-800">Transactions et Revenus par Agent</h4>
        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody>
            {performanceData.map((item, index) => (
              <tr key={item.agent} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                <td className="p-3 font-medium text-gray-900">{item.agent}</td>
