...
const AgentWalletCard: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="bg-gradient-to-br from-green-600 via-teal-600 to-blue-700 p-8 rounded-2xl shadow-2xl animate-pulse">
  ...
  return (
    <>
      <div className="bg-gradient-to-br from-green-600 via-teal-600 to-blue-700 p-3 md:p-4 lg:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 md:hover:scale-102">
        {/* Header */}
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h3 className="text-white text-lg font-bold">Agent Wallet</h3>
              <p className="text-green-100 text-xs">Balance Overview</p>
            </div>
          </div>
        ...
        {/* Balance */}
        <div className="mb-4">
          <p className="text-green-100 text-xs mb-1">Balance courant</p>
