...
const MerchantWalletCard: React.FC = () => {
  const { wallet, loading } = useMerchantWallet();
  ...
  return (
    <>
      <div className="bg-gradient-to-br w-full from-blue-600 via-purple-600 to-indigo-700 p-4 md:p-6 lg:p-8 rounded-xl transition-all duration-300 transform hover:scale-105 md:hover:scale-102">
        {/* Header */}
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h3 className="text-white text-lg font-bold">Machand Wallet</h3>
        ...
        {/* Balance */}
        <div className="mb-4">
          <p className="text-blue-100 text-xs mb-1">Balance courrant</p>
          <div className="text-2xl font-bold text-white mb-1">
            ${animatedBalance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
          </div>
          <div className="flex items-center space-x-1">
            <TrendingUp className="w-3 h-3 text-green-300" />
            <span className="text-green-300 text-xs">+2.3% pour le mois dernier</span>
          </div>
        </div>
