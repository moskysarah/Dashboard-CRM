...
const Finance: React.FC = () => {
  ...
  if (loading) return <DashboardLayout><p className="p-6">loading_transactions</p></DashboardLayout>;
  if (error) return <DashboardLayout><p className="p-6 text-red-500">{error}</p></DashboardLayout>;

  return (
    <DashboardLayout>
      <div className="p-4 md:p-6">
        <h1 className="text-xl md:text-2xl font-bold mb-3">Finance</h1>
        <p className="text-gray-600 mb-6 text-sm md:text-base">Finance_transactions_overview</p>
