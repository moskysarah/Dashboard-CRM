...
const DashboardAdmin: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen">
      <div className={`${showCreateModal || showDeleteModal ? "opacity-100" : ""} p-4`}>
        {/* Statistiques */}
        {statsLoading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              ...
              <div className="bg-white rounded-xl shadow-xl p-4 text-center">
                ...
                <p className="text-xl font-bold text-green-600">
                  {overviewStats.users?.new_users_in_period ?? 0}
                </p>
              </div>
              <div className="bg-white rounded-xl shadow-xl p-4 text-center">
                <h3 className="text-gray-500 text-sm">Volume Total (Entrant)</h3>
                <p className="text-xl font-bold text-blue-600">
                  {overviewStats.financials?.total_volume_in ?? 0} $
                </p>
              </div>
              <div className="bg-white rounded-xl shadow-xl p-4 text-center">
                <h3 className="text-gray-500 text-sm">Taux de Succès (Tx)</h3>
                <p className="text-xl font-bold text-purple-600">
                  {overviewStats.transactions?.success_rate_percent ?? 0} %
                </p>
              </div>
            </div>
          )
            ...
            <div className="flex justify-between items-center w-full px-4 py-2 mt-4">
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-2 py-1 rounded bg-green-500 text-white hover:bg-green-600 text-xs  cursor-pointer"
                >
                  Créer un utilisateur
                </button>
                <button
                  onClick={() => setShowDeleteModal(true)}
                  className="px-2 py-1 rounded bg-red-600 text-white hover:bg-red-500 text-xs cursor-pointer"
                >
        ...
        <SectionCard title={"Liste des Transactions"}>
          <TransactionsList />
        </SectionCard>
      ...
      {/*  Modal Création Utilisateur - fond transparent */}
      {showCreateModal && (
      ...
      {/*  Modal Suppression - fond transparent */}
      {showDeleteModal && (
        <div className="fixed inset-0 bg-white/70 backdrop-blur-sm flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-xl shadow-2xl w-96 border border-gray-200">
            <h3 className="text-lg font-bold mb-4">
